...
class DirectoryIterator(Iterator):
    ...
    def _my_get_batches_of_transformed_samples(self, index_array):
        #aca hay que reimplementar la forma de extraer batch_x en principio usar append
        batch_x = []
        # build batch of image data
        for i, j in enumerate(index_array):
            fname = self.filenames[j]
    ...
    def my_next(self):
        ...
        # The transformation of images is not under thread lock
        # so it can be done in parallel
        return self._my_get_batches_of_transformed_samples(index_array)
